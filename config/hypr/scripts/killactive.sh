...
for panel in wallpaper-engine sidebar wallpaper calendar; do
...
case "$ACTIVE_TITLE" in
    "Jeme OS Settings"|"ML4W Dotfiles Settings")
        qs -p $HOME/.local/share/ml4w-dotfiles-settings/quickshell ipc call settings close
        ;;
    "ML4W Welcome"|"Jeme Welcome")
        qs ipc call welcome close
        ;;
    *)
