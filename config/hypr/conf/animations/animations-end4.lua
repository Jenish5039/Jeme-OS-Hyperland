...
hl.animation({ leaf = "layersIn", enabled = true, speed = 3, bezier = "menu_decel", style = "popin 80%" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 1.4, bezier = "menu_accel", style = "slide bottom" })
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 2, bezier = "menu_decel" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1.4, bezier = "menu_accel" })
