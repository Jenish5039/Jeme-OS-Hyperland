...
hl.bind(mainMod .. " + CTRL + SHIFT + A", hl.dsp.exec_cmd("kitty -e agy"), { description = "Open Antigravity AI" })
...
hl.bind(mainMod .. " + D", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }), { description = "Toggle Maximize Window" })
hl.bind(mainMod .. " + z", hl.dsp.window.float({ action = "toggle" }), { description = "Toggle Floating" })
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("~/.config/hypr/scripts/minimize.sh"), { description = "Minimize active window" })
...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("qs ipc call wallpaper-engine toggle"), { description = "Toggle Jeme Wallpaper Engine" })
...
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { description = "Open application launcher" })
...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl -e0.6 -n2 set 5%+"),                  { locked = true, repeating = true, description = "Increase brightness" })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("brightnessctl -e0.6 -n2 set 5%-"),                  { locked = true, repeating = true, description = "Decrease brightness" })
